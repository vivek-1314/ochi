...
function cards() {
  return (
    <div className='px-14 bg-zinc-900 w-full h-[50vh] flex gap-4 justify-around items-center'>
        <div className="relative w-1/2 h-full bg-green-700 rounded-lg flex justify-center items-center">
            <svg
          width="250"    
          height="60"
          viewBox="0 0 72 30"
        ...
        >
          ...
          ></path>
            ...
            <button className='absolute bottom-5 left-8 rounded-full py-1 px-4 text-[0.85rem] border-[0.08rem] border-x-green-50'>&#169;2019-2020</button>
        </div>
        <div className="w-1/2 h-full flex gap-4 justify-around items-center">
            ...
            <div className="w-1/2 h-full bg-[#212121] rounded-lg flex justify-center items-center">
                <img className='h-[7vw] w-[7vw]' src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="" /></div>
        </div>
    </div>
  )
}
